            ...
            if (emp_publico){
                ...
                if (!provincia.equals("")){
            		...
            		while (results.hasNext())
            		{
                        ...
                        res = given+"_ "+" "+org_gestorstr+"_ "+provincia;
                        resultado.add(res);
                    }

                }
                    if (!org_Gestor.equals("")){
                    String queryString = 
                        "PREFIX JobSearch: <http://www.semanticweb.org/Group07/ontology/JobSearch#>"+
                        "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
                        "PREFIX resc: <http://www.semanticweb.org/Group07/resources/>"+
            		...
            		while (results.hasNext())
            		{
                        ...
                        res = given+"_ "+" "+org_Gestor+"_ "+provstr;
                        if(!resultado.contains(res)){
                            resultado.add(res);
                        }
                    }
                }
                if(org_Gestor.equals("") && provincia.equals("")){
                    String queryString = 
                        "PREFIX JobSearch: <http://www.semanticweb.org/Group07/ontology/JobSearch#>"+
                        "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
                        "PREFIX resc: <http://www.semanticweb.org/Group07/resources/>"+
            		...
            		while (results.hasNext())
            		{
                        ...
                        res = given+"_ "+" "+org_gestorstr+"_ "+provstr;
                        if(!resultado.contains(res)){
                            resultado.add(res);
                        }
                    }
                ...
                if (!provincia.equals("")){
            		...
            		while (results.hasNext())
            		{
                        ...
                        res = given+"_ "+" "+localstr+"_ "+provincia;
                        resultado.add(res);
                    }
                }
                if (!localidad.equals(model)){
                    String queryString = 
                        "PREFIX JobSearch: <http://www.semanticweb.org/Group07/ontology/JobSearch#>"+
                        "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
                        "PREFIX resc: <http://www.semanticweb.org/Group07/resources/>"+
            		...
            		while (results.hasNext())
            		{
                        ...
                        res = given+"_ "+" "+localidad+"_ "+provstr;
                        if(!resultado.contains(res)){
                            resultado.add(res);
                        }
                    }
                ...
                if ( localidad.equals("") && provincia.equals("")){
            		...
            		while (results.hasNext())
            		{
                        ...
                        String provstr= prov.toString();
                        provstr= provstr.substring(45);
                        res = given+"_ "+" "+localstr+"_ "+provstr;
                        resultado.add(res);
                    }
                }
            }
