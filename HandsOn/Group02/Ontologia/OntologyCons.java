...
public class OntologyCons {
	...
	public static final IRI ontologyiri = IRI.create("http://www.semanticweb.org/webSemantica/grupo02/");
	...
	public static void main(String[] args)
		...
		OWLClass Baño = crearClase("Banio");
		OWLClass restaurante = crearClase("restaurante");
		...
		OWLDeclarationAxiom decBaño = declararClases(Baño);
		OWLDeclarationAxiom decRestaurante = declararClases(restaurante);
		...
		OWLObjectProperty tieneLinea = createObjectProperty("tieneLinea");
		/*creamos las dataproperty*/
		OWLDataProperty tieneNombre = createDatatypeProperty("tieneNombre");
		OWLDataProperty tieneX = createDatatypeProperty("tieneCoordenada-X");
		OWLDataProperty tieneY = createDatatypeProperty("tieneCoordenada-Y");
		...
		OWLDeclarationAxiom tieneLineasDec = declareProperty(tieneLinea);
		...
		OWLObjectPropertyDomainAxiom tieneDomain = declareObjectDomain(tieneLinea, parada_metro);
		...
		applyChanges(m, o, decRestaurante);
		applyChanges(m, o, decBaño);
		applyChanges(m, o, subClase1);
		applyChanges(m, o, subClase2);
		/* propiedades */
		applyChanges(m, o, tieneLineasDec);
