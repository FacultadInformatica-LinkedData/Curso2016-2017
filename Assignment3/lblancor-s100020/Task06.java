...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		OntClass person = model.createClass(ns+"Person"); // create a new class "Person"
		person.addSubClass(researcher); // researcher now is subclass of person
		...
		Individual johnSmith = researcher.createIndividual(ns+"John Smith"); // create individual John Smith
		Individual upm = university.createIndividual(ns+"UPM"); // create individuak upm
		johnSmith.addProperty(worksIn, upm); // now John Smith works in UPM in our ontModel
		//johnSmith.setPropertyValue(worksIn, upm); // ¿what is the difference with the previous line?
