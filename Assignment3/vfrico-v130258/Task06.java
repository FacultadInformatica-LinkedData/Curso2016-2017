...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Individual janeSmithResearcher = model.createIndividual(ns+"JaneSmith", researcher);
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		janeSmithResearcher.addProperty(VCARD.FN, "Jane Smith");
		janeSmithResearcher.addProperty(VCARD.Given, "Jane");
		janeSmithResearcher.addProperty(VCARD.Family, "Smith");
		
		// ** TASK 6.6: Add UPM as the university where John Smith works **
		Individual upm = model.createIndividual(ns+"UPM", university);
		janeSmithResearcher.addProperty(worksIn, upm);
