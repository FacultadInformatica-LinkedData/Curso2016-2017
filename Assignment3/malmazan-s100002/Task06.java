...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		JaneSmith.addLiteral(VCARD.FN, "Jane Smith"); /* Full Name */
		JaneSmith.addLiteral(VCARD.Given, "Jane"); /* Given name */
		JaneSmith.addLiteral(VCARD.Family, "Smith"); /* FAmily names */
		
		// ** TASK 6.6: Add UPM as the university where John Smith works **
		Individual UPM = university.createIndividual(ns+"UPM");
		Individual JohnSmith = researcher.createIndividual(); /* New individual researcher named John Smith*/
