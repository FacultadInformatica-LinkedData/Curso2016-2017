...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		OntProperty worksIn = model.createOntProperty("worksIn"); // createOntProperty es igual que createProperty excepto 
															 // que te devuelve directamente un objeto tipo
															 // OntProperty en vez de un Property generico --> Creo que es más conveniente.
		...
		Individual upm= university.createIndividual(ns+"UPM");// La creamos porque no esta en el modelo
		john.addProperty(model.getProperty("worksIn"), upm);
		
		model.write(System.out, "RDF/XML-ABBREV"); //Este tipo de OUTPUT no funciona. Con Turtle SI
	}
}
