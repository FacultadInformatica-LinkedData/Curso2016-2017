...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		OntProperty worksInProperty = model.createOntProperty(ns+"worksIn");
		...
		Individual johnSmith = model.createIndividual(ns+"JohnSmith", researcher);
		johnSmith.addProperty(worksInProperty, upm);
