...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		//ExtendedIterator<Individual> indiv = model.listIndividuals();
		Individual johnSmith = model.getIndividual(ns+"JohnSmith");
//		while (indiv.hasNext()) {
//			Individual ind = indiv.next();
//			if (ind.toString().equals(ns+"JohnSmith")) {
//				ind.addProperty(worksIn, upm);
//			}
//		}
