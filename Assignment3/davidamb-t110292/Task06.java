...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Property worksIn=model.createProperty(rdfNS,"worksIn");
		
		// ** TASK 6.4: Create a new individual of Researcher named "Jane Smith" **
		Resource janeSmith = model.createResource(ns+"JaneSmith");
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		janeSmith.addLiteral(VCARD.FN, "Jane Smith").addLiteral(VCARD.Given, "Jane").addProperty(VCARD.Family, "Smith");
