...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Individual janeS = researcher.createIndividual(ns + "Jane Smith");
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		janeS.addProperty(VCARD.FN, "Jane Smith");
		janeS.addProperty(VCARD.Given, "Jane");
		janeS.addProperty(VCARD.Family, "Smith");
		
		// ** TASK 6.6: Add UPM as the university where John Smith works **
		Individual upm = university.createIndividual(ns + "UPM");
		Individual jonhSmith = researcher.createIndividual(ns + "Jonh Smith"); 
