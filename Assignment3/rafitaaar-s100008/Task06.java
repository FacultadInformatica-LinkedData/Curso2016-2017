...

{
...

	{
		...
		OntClass person=model.createClass(ns + "Person"); // creamos la clase Person y añadimos la subclass
		...
		johnSmith.addProperty(worksIn, upm); // usamos la propiedad creada en la task 6.3
