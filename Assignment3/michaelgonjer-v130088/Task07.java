...
public class Task07
{
	...
	public static void main(String args[])
	{
		...
		System.out.println("TASK 7.3: Make the necessary changes to get as well indirect instances and subclasses. TIP: you need some inference...");
		it = model.listIndividuals(person);
		while(it.hasNext()){
			System.out.println("Direct Individual: "+it.next());
		}
		...
		while(it3.hasNext()){
			...
			while(it4.hasNext())
				System.out.println("Indirect Individual: "+it4.next());
